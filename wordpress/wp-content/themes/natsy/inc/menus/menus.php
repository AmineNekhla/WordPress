...
function nova_get_theme_menus() {
	$menus = array(
		'nova_topbar_menu' 		=> esc_html__('Top Bar (Mobile)', 'natsy'),
		'nova_menu_primary' 		=> esc_html__('Main Navigation', 'natsy'),
		'nova_menu_fullscreen' 		=> esc_html__('Fullcreen Menu', 'natsy'),
