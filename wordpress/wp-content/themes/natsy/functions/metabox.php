...
function nova_add_custom_product_metabox( $meta_boxes ) {
    ...
    $theme_meta_boxes[] = [
        'title'      => esc_html__( 'Header Image', 'natsy' ),
        'id'         => 'header-image',
        'post_types' => ['product'],
        'context'    => 'normal',
        'priority'   => 'high',
  ...
  $theme_meta_boxes[] = [
      'title'      => esc_html__( 'For post format QUOTE', 'natsy' ),
      'id'         => 'format_quote',
      'post_types' => ['post'],
      'context'    => 'normal',
      'priority'   => 'high',
      'fields'     => [
          [
              'type' => 'textarea',
              'name' => esc_html__( 'Quote Content', 'natsy' ),
              'id'   => $prefix.'post_quote_content',
          ],
          [
              'type' => 'text',
              'id'   => $prefix . 'post_quote_author',
              'name' => esc_html__( 'Author', 'natsy' ),
          ],
          [
              'type' => 'color',
              'id'   => $prefix . 'post_quote_text_color',
              'name' => esc_html__( 'Text Color', 'natsy' ),
              'std'  => '#000',
          ],
          [
              'type' => 'color',
              'id'   => $prefix . 'post_quote_bg_color',
              'name' => esc_html__( 'Background Color', 'natsy' ),
              'std'  => '#FFF',
          ],
      ],
  ];
  $theme_meta_boxes[] = [
      'title'      => esc_html__( 'For post format VIDEO', 'natsy' ),
      'id'         => 'format_video',
      'post_types' => ['post'],
      'context'    => 'normal',
      'priority'   => 'high',
      'fields'     => [
          ...
          [
              ...
              'name' => esc_html__( 'Youtube/Vimeo Video Url', 'natsy' ),
          ],
      ],
  ];
  $meta_boxes = apply_filters('natsy/metabox/meta_boxes',$theme_meta_boxes);
  return $meta_boxes;
}
