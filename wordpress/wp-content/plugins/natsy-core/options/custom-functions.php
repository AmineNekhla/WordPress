<?php
function natsy_core_css() {
    $prefix = NOVA_THEMEPREFIX;
    $ver = '2.2.9';
    if (!is_customize_preview()  && is_admin() ) {
        wp_register_style($prefix.'-csf-custom-css', NOVA_PLUGIN_URL.'/options/css/custom-panel.css', null, $ver);
        wp_enqueue_style($prefix.'-csf-custom-css');
        wp_enqueue_script( 'csf-custom-modules', NOVA_PLUGIN_URL.'/options/js/csf-modules.js', array('jquery'), $ver, true );

    }
    if (is_customize_preview()  && is_admin() ) {
        wp_register_style($prefix.'-csf-customizer-css', NOVA_PLUGIN_URL.'/options/css/customizer-panel.css', null, $ver);
        wp_enqueue_style($prefix.'-csf-customizer-css');
    }

}
add_action('admin_enqueue_scripts', 'natsy_core_css', 20 );
...
add_filter( 'redux/font-icons', 'nova_get_font_icons' );
